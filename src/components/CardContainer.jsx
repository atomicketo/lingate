...
const CardContainer = props => {
  const data = [
    ...
    },
    {
      title: "Limits",
      desc:
        "A limit is the value that a function (or sequence) approaches as the input (or index) approaches some value. Limits are essential to calculus (and mathematical analysis in general)",
      image:
